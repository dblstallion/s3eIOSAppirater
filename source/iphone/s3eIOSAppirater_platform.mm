...
void s3eIOSAppiraterParams_platform(int appId, int usesUntilPrompt, int daysUntilPrompt, int daysRemindLater, int numSignificantEvents, const char * rateNowTitle, const char * rateNowText, const char * rateNowYesButton, const char * remindTitle, const char * remindText, const char * remindYesButton, const char * commonNoButton)
{
    ...
    NSString *nsCommonNoButton = [NSString stringWithUTF8String:commonNoButton];
    
    [g_appirater setParams: appId: usesUntilPrompt: daysUntilPrompt: daysRemindLater: numSignificantEvents: nsRateNowTitle: nsRateNowText: nsRateNowYesButton: nsRemindTitle: nsRemindText: nsRemindYesButton: nsCommonNoButton];
}
